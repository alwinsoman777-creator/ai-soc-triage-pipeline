Run this command to write the documentation directly:
...
The event flows through Sysmon $\rightarrow$ Wazuh Manager $\rightarrow$ wazuh-integratord $\rightarrow$ FastAPI Webhook.
Click anywhere on the incident row to expand the drawer and inspect:
